...
<nav class="navbar navbar-toggleable-md navbar-light bg-faded sticky-top">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul class="navbar-nav mr-auto mt-2 mt-md-0">
            ...
            <li class="nav-item " >
                <a class="nav-link" href="RegistrarProducto.php" >
                    <i class="fa fa-sign-in" aria-hidden="true"></i>
                    Registrar Producto
                </a>
            </li>
            <li class="nav-item " >
                <a class="nav-link active" href="ActualizarProducto.php" >
...
<!-- Registro producto. -->
<div class="container">
    <form action="../Controlador/ActualizarProductoC.php" method="post" enctype="multipart/form-data">
